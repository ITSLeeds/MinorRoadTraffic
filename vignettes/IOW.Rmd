...
cents_test = as(cents_test, "Spatial")

# Define Equation
eq = traffic_flow_minor ~ log(std_centrality) + log(nearest_junc_dist) + log(major_flow) +
...
plot(cents_test$traffic_flow_minor, predict(gwpr4),
     xlab = "Obsereved AADT",
     ylab = "Predicted AADT")
abline(0,1)
```
